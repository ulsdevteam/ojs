...
/**
 * @file plugins/reports/counter/classes/reports/JR1_r3_0.inc.php
 *
...
import('plugins.reports.counter.classes.releases.CounterRelease3_0');

class JR1_r3_0 extends CounterRelease3_0 {

	/**
	 * Constructor
	 * @param $parentPluginCategory string
	 * @param $parentPluginName string
	 */
	function JR1_r3_0($parentPluginCategory, $parentPluginName) {
		parent::CounterRelease3_0($parentPluginCategory, $parentPluginName);
	}
	...
	* Internal function to collect structures for output
	...
	function _reportXML(&$request, $year, $useLegacyStats) {
		...
		$templateManager->display($this->getParentPlugin()->getTemplatePath() . 'reportxml.tpl', 'text/xml');
	}
